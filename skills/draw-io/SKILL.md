---
name: draw-io
description: Create, edit, and review draw.io diagrams with precise XML manipulation. Covers .drawio XML editing with coordinate calculations, high-resolution PNG conversion via scripts and pre-commit hooks, layout and spacing adjustment, AWS icon search and integration, and diagram quality verification. Use when working with .drawio files or when the user needs diagrams in draw.io format rather than Mermaid.
---
