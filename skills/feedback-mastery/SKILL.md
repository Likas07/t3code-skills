...
description: Navigate difficult workplace conversations, deliver constructive feedback, and resolve conflicts using structured frameworks. Covers Preparation-Delivery-Follow-up model, Situation-Behavior-Impact (SBI) feedback technique, and emotional regulation strategies. Use when preparing for difficult conversations, giving or receiving performance feedback, addressing conflicts between team members, discussing sensitive topics (salary, promotion, termination), managing stakeholder expectations, or handling emotional/defensive reactions.
...
This skill provides frameworks for navigating difficult workplace conversations and delivering effective feedback. Whether you're addressing performance issues, resolving conflicts, discussing sensitive topics, or giving constructive feedback, these structured approaches lead to better outcomes.
...
- Needing to escalate unresolved issues

**Keywords**: feedback, difficult conversation, 1:1, one-on-one, performance, conflict, expectations, behavior, confrontation, salary, promotion, termination, escalation
...
When preparing for or delivering feedback, distinguish three layers:

- **What happened:** Observable behavior (facts)
- **What I felt:** Your emotional response (impact)
...
| Minimum acceptable result | "At minimum, I need acknowledgment and a timeline" |
...
| Defensive | Identify your own contribution |
...
- What might trigger them during this conversation?
...
| Sensitive topic | "I'd like to discuss something important. I want to be direct and also hear your thoughts." |
...
- [ ] **Maintain relationship** - Separate the issue from the person; rebuild trust over time
...
### Scenario: Peer Conflict (Public Criticism)

**Situation:** A colleague publicly criticized your work in a meeting.

**Approach:**

1. **Prepare:** Clarify the issue (observable behavior: what they said), impact (embarrassment, trust damage), and goal (address behavior, rebuild relationship)
2. **Deliver:** "I'd like to talk about what happened in yesterday's standup. When you said my code 'missed obvious issues,' I felt called out in front of the team. I'd like to understand your concerns and find a better way to handle code quality feedback."
3. **Collaborate:** Discuss preferred feedback channels (private DM, PR comments)
4. **Follow-up:** Monitor if behavior changes

### Scenario: Discussing Compensation

**Situation:** You feel underpaid relative to market/contribution.

**Approach:**

1. **Prepare:** Research market rates, document contributions and impact
2. **Deliver:** "I'd like to discuss my compensation. I've been here two years, taken on the payments project leadership, and want to make sure my salary reflects my contributions and the current market."
3. **Collaborate:** Ask about timeline, what would need to happen
4. **Follow-up:** Get any commitments in writing

### Scenario: Sensitive Topics

**Situation:** Discussions involving salary, promotion, termination, or personal matters.
...
Escalate the conversation to management or HR when:

- Safety is at risk
- Legal issues are involved
- Repeated conversations haven't produced change
...
- `references/difficult-conversation-scripts.md` - Opening lines and responses for various scenarios
- `references/expectation-alignment.md` - Managing stakeholder expectations
- `references/conversation-framework.md` - Complete three-phase framework with scripts and examples
- `references/preparation-template.md` - Worksheet for preparing before difficult conversations
- `references/delivery-scripts.md` - Opening lines, response handling, reframing techniques
- `references/emotional-regulation.md` - Managing your own emotions before and during conversations
